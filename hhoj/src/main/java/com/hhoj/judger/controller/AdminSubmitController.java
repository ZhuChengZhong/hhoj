...
public class AdminSubmitController {
	...
	private static Logger logger=LoggerFactory.getLogger(AdminSubmitController.class);
	...
	public ModelAndView list(Submit submit,@RequestParam(required=false,value="pid") Integer pid,@PathVariable(value="page") Integer page,HttpServletRequest request) {
		...
		String url=contextPath+"/manager/submit/list";
