...
<body>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li id="problem_result" role="presentation"><a href="#problem_result" onclick="submit_list(${problem.pid})" aria-controls="problem_result"  role="tab" data-toggle="tab">运行结果</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active problem-position" id="problem_message">
           ...
           <p class="problem_name"><font class="font-style">时间：${problem.timeLimit} | 内存：${problem.memaryLimit}</font></p>
         ...
         <dl>   
          ...
          <dt class="">样例输入：</dt>
          <dd>
            <pre>&lt;p&gt;${problem.inputExample }&lt;/p&gt;</pre>
          </dd>
          <dt class="">样例输出：</dt>
          <dd>
           <pre>&lt;p&gt;${problem.outputExample }&lt;/p&gt;</pre>
          </dd>
          <dt class="">来源：</dt>
